export default {
  ...
  setting: {
    ...
    openSource: 'Этот проект открыт исходным кодом на',
    freeMIT: 'бесплатный и основан на лицензии MIT, без какой-либо формы платного поведения!',
    stars: 'Если вы нашли этот проект полезным, пожалуйста, нажмите на рекламную ссылку на этом сайте, спасибо!',
