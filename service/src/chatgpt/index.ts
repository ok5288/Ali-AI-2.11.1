...
const ErrorCodeMessage: Record<string, string> = {
  401: '[系统提示] 提供错误的API密钥 | Incorrect API key provided',
  403: '[系统提示] 服务器拒绝访问，请稍后再试 | Server refused to access, please try again later',
  502: '[系统提示] 错误的网关 |  Bad Gateway',
  503: '[系统提示] 服务器繁忙，请稍后再试 | Server is busy, please try again later',
  504: '[系统提示] 网关超时 | Gateway Time-out',
  500: '[系统提示] 服务器繁忙，请稍后再试 | Internal Server Error',
}
